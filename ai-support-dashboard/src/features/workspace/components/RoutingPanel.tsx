    ...
    <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl overflow-hidden">
      <div className="bg-zinc-900 border-b border-zinc-800 p-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold text-zinc-100">Assignment</h3>
        </div>
      </div>

      <div className="p-4 space-y-5">
        <div>
           <span className="text-xs font-semibold text-zinc-400 uppercase tracking-wider mb-2 block">Assigned To</span>
           <div className="flex gap-2 items-center">
             <Badge variant="outline" className="text-zinc-200 border-zinc-700 bg-zinc-800 text-sm py-1">
        ...
        <div>
          <span className="text-xs font-semibold text-zinc-400 uppercase tracking-wider mb-2 block">Routing Explanation</span>
          <div className="bg-zinc-950 border border-zinc-800 rounded-lg p-3 space-y-3">
            ...
            <div>
              <div className="flex items-center gap-1.5 mb-1">
                ...
                <span className="text-[11px] text-zinc-400 font-semibold uppercase">Reason</span>
              </div>
            ...
            <div className="border-t border-zinc-800 pt-3">
              <div className="flex items-center gap-1.5 mb-1">
                ...
                <span className="text-[11px] text-zinc-400 font-semibold uppercase">Rule Triggered</span>
              </div>
              <div className="pl-5 flex justify-between items-center">
                <code className="text-[10px] text-purple-400 bg-purple-400/10 px-1.5 py-0.5 rounded border border-purple-500/20">
