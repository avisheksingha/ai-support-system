    ...
    <div className="h-full w-full overflow-auto p-6">
      <div className="max-w-2xl space-y-6 mx-auto md:mx-0">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Your account details and access level.</p>
        </div>
        ...
        <div className="rounded-xl border border-border bg-card overflow-hidden">
          ...
          <div className="px-6 pb-6">
            <div className="flex items-end gap-4 -mt-10 mb-5">
              <div className="h-20 w-20 rounded-full bg-[#0C66E4] flex items-center justify-center shadow-md ring-4 ring-card text-white text-2xl font-bold">
                {initials}
              </div>
            <div className="pb-1">
      ...
      {/* Info banner */}
      <div className="flex items-start gap-3 p-4 rounded-xl bg-blue-500/8 border border-blue-500/20 text-blue-300">
