...
export function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-zinc-950 px-4 text-center">
      <div className="rounded-full bg-zinc-900 p-6 mb-8 border border-zinc-800 shadow-xl shadow-black/40">
      ...
      <Link to="/">
        <Button size="lg" className="bg-indigo-600 hover:bg-indigo-700 text-white shadow-lg shadow-indigo-900/20 border-none transition-all">
