...
public class TicketOrchestratedConsumer {
    ...
    public void consume(ConsumerRecord<String, String> consumerRecord) {
        ...
        try {
            ...
            log.error("Failed to process ticket-orchestrated event key={}", consumerRecord.key(), ex);            
            throw new TicketEventProcessingException("Error processing ticket-orchestrated event", ex);
        } finally {
